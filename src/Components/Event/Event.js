...
class Event extends Component {
    render() {
        return (
			<div className="event">
                <span className="date">{moment(this.props.data.date).format('MMM DD, YYYY')}</span>
                <span className="content">
                    <div className="data">
                        <div className="text title">{this.props.data.title}</div>
                    ...
                    </div>
                    {
                        ...
                        <div className="tickets">
                            ...
                            {this.props.data.tickets.vip ? <a className="ticket vip" href={this.props.data.tickets.vip}>VIP Ticket</a> : null}
                        </div>
                    }
                </span>
            </div>
